...
afxInit0
	...
	ld		hl,PSG_SEL*256+PSG_WR	;initialize AY
	ld		e,15
afxInit1
	dec		e
	ld		c,h
...
afxFrame0
	...
	ld		c,PSG_SEL				;output the volume value
	out		(c),a
	ld		a,e
	and		$0f
	ld		c,PSG_WR
	...
	ld		c,PSG_SEL				;output the tone values
	out		(c),a
	ld		d,(hl)
	inc		hl
	ld		c,PSG_WR
...
afxFrame7
	...
	ld		hl,PSG_SEL*256+PSG_WR	;output the value of noise and mixer
afxNseMix
